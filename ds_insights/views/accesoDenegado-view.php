<?php
/* Pantalla mostrada cuando el rol no tiene acceso a Insights o a una vista.
   No dice QUE vista falta ni que permiso: quien no entra no debe aprender
   nada del sistema por el camino. */
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="ds-container d-flex align-items-center justify-content-center" style="min-height:100vh;">
        <div class="text-center" style="max-width:520px;">
            ...
            <p style="color:var(--ds-text-muted);margin-bottom:28px;">
                Su rol no tiene permiso para acceder a esta sección de Insights.
