<?php
	...
	$insRepreSede = new reporteController();

	if(isset($_POST['alumno_sedeid'])){
		$alumno_sedeid = $insRepreSede->limpiarCadena($_POST['alumno_sedeid']);
	} ELSE{
		$alumno_sedeid = 0;
	}
?>
...
<html lang="es">
  <head>
	...
	<title><?php echo APP_NAME; ?>| Representantes por sede</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<div class="content-header">
			...
			<div class="row mb-2">
				<div class="col-sm-6">
				<h1 class="m-0">Representantes por sede</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
		...
		<!-- Section listado de representantes -->
		<section class="content">
			<form action="<?php echo APP_URL."reporteRepresentantesSede/" ?>" method="POST" autocomplete="off" enctype="multipart/form-data" >
			<div class="container-fluid">
				...
				<div class="card card-default">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped table-sm" style="font-size: 13px;">
							...
							<tbody>
								<?php
									echo $insRepreSede->listarRepresentantesPorSede($alumno_sedeid);
								?>
							</tbody>
						</table>
					</div>
