			...
			foreach($datos as $rows){	
				...
				$tabla.='				
					<tr>
						...
						<td>							
							'.$this->siPuede('crear','representanteList','<a href="'.APP_URL.'alumnoNew/'.$rows['repre_id'].'/" class="btn float-end btn-secondary btn-sm" style="margin-right: 5px;"><i class="fas fa-plus me-1"></i>Nuevo Alumno</a>').'	
							'.$this->siPuede('crear','representanteList','<a href="'.APP_URL.'representanteVinc/'.$rows['repre_id'].'/" class="btn float-end btn-warning btn-sm" style="margin-right: 5px;"><i class="fas fa-link me-1"></i>Vincular alumno</a>').'
						</td>
						<td>
						...
						<td>
							...
							'.$this->siPuede('editar','representanteList','<a href="'.APP_URL.'representanteUpdate/'.$rows['repre_id'].'/" class="btn float-end btn-actualizar btn-sm" style="margin-right: 5px;" title="Actualizar" aria-label="Actualizar"><i class="fas fa-pen"></i></a>').'							
							<a href="'.APP_URL.'representanteProfile/'.$rows['repre_id'].'/" class="btn float-end btn-ver btn-sm" style="margin-right: 5px;" title="Ver" aria-label="Ver"><i class="fas fa-eye"></i></a>							
						</td>
					</tr>';	
			}
			return $tabla;			
					...
					<tr>
						...
						<td>
							'.$this->siPuede('editar','representanteList','<form class="FormularioAjax" action="'.APP_URL.'app/ajax/representanteAjax.php" method="POST" autocomplete="off" >
								...
								<button type="submit" href="'.APP_URL.'representanteList/" class="btn float-end btn-success btn-sm" style="margin-right: 5px;"><i class="fas fa-link me-1"></i>Vincular</button>							
