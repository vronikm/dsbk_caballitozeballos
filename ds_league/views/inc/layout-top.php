<?php
/*
| Cabecera común de las vistas de DigiSports League.
...
<head>
    ...
    <style>
        /* League usa el acento violeta que ya tiene asignado en digisports.css. */
        .ds-core .nav-sidebar .nav-link.active { background: var(--ds-league) !important;
                                                 box-shadow: 0 6px 18px rgba(167,139,250,.30); }
        .ds-core .btn-primary { background: var(--ds-league); border-color: var(--ds-league); }
        .ds-core .btn-primary:hover, .ds-core .btn-primary:focus {
            background: #8b5cf6; border-color: #8b5cf6; }
        .ds-core .switch input:checked + span { background: var(--ds-league); }
    </style>
</head>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 ds-core__sidebar">
        <a href="<?php echo APP_URL; ?>panel/" class="brand-link">
            <img src="<?php echo DS_HUB_URL; ?>ds_core/assets/img/logo_ds.png"
                 alt="League" class="brand-image img-circle elevation-3" style="opacity:.85">
            <span class="brand-text font-weight-light">League</span>
        </a>

        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    <?php echo $insLeague->menuLateral($vistaActual); ?>
                </ul>
            </nav>
        </div>
    </aside>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo APP_URL; ?>panel/">League</a></li>
