<?php
/* Pantalla mostrada cuando el rol no tiene acceso al módulo Core o a una
   de sus vistas. Autónoma: no depende del layout ni del menú lateral. */
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="ds-container d-flex align-items-center justify-content-center" style="min-height:100vh;">
        <div class="text-center" style="max-width:520px;">
            ...
            <p style="color:var(--ds-text-muted);margin-bottom:28px;">
                Su rol no tiene permiso para acceder a esta sección de la administración.
                Si considera que se trata de un error, solicite a un administrador que revise
                sus permisos en el módulo Core.
            </p>
